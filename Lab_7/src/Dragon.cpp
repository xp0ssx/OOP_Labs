...
Dragon::Dragon(std::string hName, short int x, short int y) : Heroes(DRAGON, hName, x, y, RANGE_ATTACK_DR, RANGE_MOVE_DR) {}

Dragon::Dragon(std::istream & is) : Heroes(DRAGON, is)
{
    _rangeAttack = RANGE_ATTACK_DR;
    _rangeMove = RANGE_MOVE_DR;
}
